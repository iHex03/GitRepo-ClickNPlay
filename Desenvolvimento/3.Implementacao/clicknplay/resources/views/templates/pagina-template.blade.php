      ...
      <footer class="bg-dark text-center text-white">
        <div class="container p-4">
            <section class="mb-4">
                ...
                <!-- Google -->
                <a class="btn btn-outline-light btn-floating m-1" href="#!" role="button">
                    <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" fill="currentColor" class="bi bi-google" viewBox="0 0 16 16">
            ...
            <section class="mb-4">
                <p>Trabalho feito com muito amor e ódio!</p>
            </section>

            <section class="">
                <div class="row">
                    <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
                        <h5 class="text-uppercase">Gabriel Barbosa</h5>
                        <h8>Back-end</h8>
                    </div>

                    <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
                        <h5 class="text-uppercase">Gabriel Lara</h5>
                        <h8>Product Owner</h8>
                    </div>
                
                    <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
                        <h5 class="text-uppercase">Marcel</h5>
                        <h8>Scrum Master</h8>
                    </div>

                    <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
                        <h5 class="text-uppercase">Bruno</h5>
                        <h8>Front-end</h8>
                    </div>
        ...
        <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
            © 2021 Copyright:
            <a class="text-white" href="#">gaia.ifsp.com</a>
        </div>
    </footer>
